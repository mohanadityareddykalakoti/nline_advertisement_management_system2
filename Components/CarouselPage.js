    ...
    <>
          ...
          <div className="row">
            <div className="col col-md-6 col-sm-12">
              <div className="team text-center">
                ...
                <div className="person-body">
                  <h3 className="staff-name">Mohan Aditya</h3>
            ...
            <div className="col col-md-6 col-sm-12">
              <div className="team text-center">
                ...
                <div className="person-body">
                  <h3 className="staff-name">Preetham Reddy</h3>
                  <span className="d-block position mb-4">
                    Full stack Developer
                  </span>
                  <p className="mb-4">
      ...
      <div className="untree_co-section">
        <div className="testimonial-grid">
          ...
          >
            <blockquote>
              &ldquo;"Seize the Moment: Elevate every experience with a touch of luxury and grace."&rdquo;
              <div className="person-image mt-3 d-flex align-items-center">
              
                <div>
                  <span className="name">Jasswanth Reddy</span>
